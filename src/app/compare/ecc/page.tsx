      ...
      <section className="border-b bg-white sticky top-[49px] z-40">
        <div className="mx-auto max-w-5xl px-6">
          <div className="flex items-center gap-1 overflow-x-auto py-3 -mx-1">
            ...
            <a href="/compare/ecc" className="shrink-0 rounded-full bg-[#1a1a2e] px-4 py-2 text-xs font-semibold text-white">vs ECC</a>
            ...
            {[
              {
                ...
                desc: "Start a free 30-day trial. Run Skill Hunter in parallel with your existing ECC contract. No disruption.",
              },
              {
                step: "2",
                period: "Week 3-4",
